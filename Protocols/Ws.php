...
class Ws
{
    ...
    public static function sendHandshake($connection)
    {
        ...
        "Sec-WebSocket-Version: 13\r\n".(isset($connection->ServerENV)?self::getWsHeaders($connection->ServerENV):'').
    ...
    //获取不同环境头信息 1 正式 0 模拟
    public static function getWsHeaders($env)
    {
        if($env==1){
            return "x-api-token: 6Couxh6yvjH4g1UL\r\n".
            "x-api-tenantid: T001273\r\n".
            "x-api-serverid: 180\r\n";
        }else{
            return "x-api-token: 6Couxh6yvjH4g1UL\r\n".
            "x-api-tenantid: T001273\r\n".
